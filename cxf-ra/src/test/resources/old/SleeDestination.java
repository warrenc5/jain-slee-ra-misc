...
import org.apache.cxf.bus.JAXWSBusFactory;
...
public class SleeDestination extends AbstractMultiplexDestination
    ...
    protected Conduit getInbuiltBackChannel(Message inMessage) {
        ...
        assert(c!=null);
        //try {
        Object o = inMessage.get("org.apache.cxf.jaxws.context.WrappedMessageContext.SCOPES");
    ...
    */
    ...
    protected OutputStream flushHeaders(Message outMessage, boolean getStream) throws IOException {
        ...
        if (responseObj instanceof HttpServletResponse) {
            ...
            String m = (new org.apache.cxf.common.i18n.Message("NULL_RESPONSE_MSG", logger)).toString();
            logger.log(Level.WARNING, m);
            throw new IOException(m);
        }
