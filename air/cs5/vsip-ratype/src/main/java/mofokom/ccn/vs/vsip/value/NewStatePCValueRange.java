        ...
        *
        **/
          public enum NewStatePCValueRange {
            ...
            private NewStatePCValueRange(java.lang.String value,String description){
              this.value = value;
            ...
            public static NewStatePCValueRange forValue(java.lang.String value){
              for(NewStatePCValueRange v: values())
                if(v.getValue().equals(value)) 
                  return v;
              throw new IllegalArgumentException("No NewStatePCValueRange value for parameter " + value);
            }
