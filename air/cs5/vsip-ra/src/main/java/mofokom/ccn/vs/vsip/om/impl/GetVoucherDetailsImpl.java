        ...
        **/
        @Generated(value={})
        public class GetVoucherDetailsImpl implements GetVoucherDetails,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("vsip.GetVoucherDetails","MOFOKOM","2.5");
...
VSIPResourceAdaptorUsageParameters usage = (VSIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GetVoucherDetails", this);
        if (serialNumber==null) 
            Util.mandatoryMissing("serialNumber","6.1.1");
        else
                encoder.encode("serialNumber",serialNumber);
        if (activationCode==null) 
            Util.mandatoryMissing("activationCode","6.1.1");
        else
        ...
        if (networkOperatorId!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GetVoucherDetails", this);
