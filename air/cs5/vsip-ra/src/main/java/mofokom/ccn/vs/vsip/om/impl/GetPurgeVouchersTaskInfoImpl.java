        ...
        /**
        *   Section Reference 6.13.1
        *
        **/
        @Generated(value={})
        public class GetPurgeVouchersTaskInfoImpl implements GetPurgeVouchersTaskInfo,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("vsip.GetPurgeVouchersTaskInfo","MOFOKOM","2.5");
...
VSIPResourceAdaptorUsageParameters usage = (VSIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GetPurgeVouchersTaskInfo", this);
        if (taskId!=null) 
        ...
        if (networkOperatorId!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GetPurgeVouchersTaskInfo", this);
