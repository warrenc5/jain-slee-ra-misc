        ...
        /**
        *   Section Reference 6.15.1
        *
        **/
        @Generated(value={})
        public class GetGenerateVoucherDetailsReportTaskInfoImpl implements GetGenerateVoucherDetailsReportTaskInfo,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("vsip.GetGenerateVoucherDetailsReportTaskInfo","MOFOKOM","2.5");
...
VSIPResourceAdaptorUsageParameters usage = (VSIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GetGenerateVoucherDetailsReportTaskInfo", this);
        if (taskId!=null) 
        ...
        if (networkOperatorId!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GetGenerateVoucherDetailsReportTaskInfo", this);
