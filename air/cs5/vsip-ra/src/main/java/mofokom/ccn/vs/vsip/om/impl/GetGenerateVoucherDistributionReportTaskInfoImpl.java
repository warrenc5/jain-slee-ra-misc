        ...
        /**
        *   Section Reference 6.17.1
        *
        **/
        @Generated(value={})
        public class GetGenerateVoucherDistributionReportTaskInfoImpl implements GetGenerateVoucherDistributionReportTaskInfo,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("vsip.GetGenerateVoucherDistributionReportTaskInfo","MOFOKOM","2.5");
...
VSIPResourceAdaptorUsageParameters usage = (VSIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GetGenerateVoucherDistributionReportTaskInfo", this);
        if (taskId!=null) 
        ...
        if (networkOperatorId!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GetGenerateVoucherDistributionReportTaskInfo", this);
