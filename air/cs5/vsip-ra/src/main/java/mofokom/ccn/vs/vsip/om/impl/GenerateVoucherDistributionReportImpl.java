        ...
        /**
        *   Section Reference 6.16.1
        *
        **/
        @Generated(value={})
        public class GenerateVoucherDistributionReportImpl implements GenerateVoucherDistributionReport,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("vsip.GenerateVoucherDistributionReport","MOFOKOM","2.5");
...
VSIPResourceAdaptorUsageParameters usage = (VSIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GenerateVoucherDistributionReport", this);
        if (batchId!=null) 
        ...
        if (schedulation!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GenerateVoucherDistributionReport", this);
       ...
       public static class SchedulationImpl implements Codeable,Schedulation{
        ...
        if (executionTime==null) 
            Util.mandatoryMissing("executionTime","6.16.1");
        else
