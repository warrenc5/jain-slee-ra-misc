        ...
        **/
        @Generated(value={})
        public class GetChangeVoucherStateTaskInfoImpl implements GetChangeVoucherStateTaskInfo,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("vsip.GetChangeVoucherStateTaskInfo","MOFOKOM","2.5");
...
VSIPResourceAdaptorUsageParameters usage = (VSIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GetChangeVoucherStateTaskInfo", this);
        if (taskId!=null) 
        ...
        if (networkOperatorId!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GetChangeVoucherStateTaskInfo", this);
