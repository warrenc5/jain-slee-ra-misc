        ...
        /**
        *   Section Reference 6.6.1
        *
        **/
        @Generated(value={})
        public class GetGenerateVoucherTaskInfoImpl implements GetGenerateVoucherTaskInfo,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("vsip.GetGenerateVoucherTaskInfo","MOFOKOM","2.5");
...
VSIPResourceAdaptorUsageParameters usage = (VSIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GetGenerateVoucherTaskInfo", this);
        if (taskId!=null) 
        ...
        if (networkOperatorId!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GetGenerateVoucherTaskInfo", this);
