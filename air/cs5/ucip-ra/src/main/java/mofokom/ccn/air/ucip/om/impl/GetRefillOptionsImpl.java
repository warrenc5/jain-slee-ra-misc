        ...
        **/
        @Generated(value={})
        public class GetRefillOptionsImpl implements GetRefillOptions,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("ucip.GetRefillOptions","MOFOKOM","4.1");
...
UCIPResourceAdaptorUsageParameters usage = (UCIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GetRefillOptions", this);
        ...
        if (voucherActivationCode==null) 
            Util.mandatoryMissing("voucherActivationCode","5.9.1");
        else
        ...
        if (messageCapabilityFlag!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GetRefillOptions", this);
