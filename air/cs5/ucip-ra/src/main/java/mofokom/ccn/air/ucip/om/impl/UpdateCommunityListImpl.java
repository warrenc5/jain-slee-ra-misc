        ...
        **/
        @Generated(value={})
        public class UpdateCommunityListImpl implements UpdateCommunityList,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("ucip.UpdateCommunityList","MOFOKOM","4.1");
...
UCIPResourceAdaptorUsageParameters usage = (UCIPResourceAdaptorUsageParameters)raUsageParameters; 
        ...
        if (subscriberNumber==null) 
            Util.mandatoryMissing("subscriberNumber","5.14.1");
        else
                encoder.encode("subscriberNumber",subscriberNumber);
        if (originOperatorID!=null) 
                encoder.encode("originOperatorID",originOperatorID);
        if (communityInformationCurrent!=null) 
             if(communityInformationCurrent.size() > 0) {
                encoder.encode("communityInformationCurrent",communityInformationCurrent);
             }
        if (communityInformationNew==null) 
            Util.mandatoryMissing("communityInformationNew","5.14.1");
        else
             if(communityInformationNew.size() > 0) {
                encoder.encode("communityInformationNew",communityInformationNew);
             }
            }
            @Override
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("UpdateCommunityList", this);
        ...
        communityInformationCurrent = (java.util.List<CommunityInformationCurrent>)decoder.decodeList("communityInformationCurrent",CommunityInformationCurrentImpl.class) ;
        communityInformationNew = (java.util.List<CommunityInformationNew>)decoder.decodeList("communityInformationNew",CommunityInformationNewImpl.class) ;
        if (communityInformationNew==null) 
            Util.mandatoryMissing("communityInformationNew","5.14.1");
            }
        ...
        buffy.append(":");
         ...
         if(communityInformationCurrent!=null){
         buffy.append("communityInformationCurrent=");
         buffy.append(communityInformationCurrent.toString());
         buffy.append(", ");
         }
	
         if(communityInformationNew!=null){
         buffy.append("communityInformationNew=");
         buffy.append(communityInformationNew.toString());
         buffy.append(", ");
         }
        ...
        **/
          private java.util.List<CommunityInformationCurrent> communityInformationCurrent=new ArrayList<CommunityInformationCurrent>();
          @Override
        ...
        *   Section Reference 5.16.7
        **/
          private java.util.List<CommunityInformationNew> communityInformationNew=new ArrayList<CommunityInformationNew>();
          @Override
