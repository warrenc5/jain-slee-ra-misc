        ...
        **/
        @Generated(value={})
        public class GetPromotionPlansImpl implements GetPromotionPlans,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("acip.GetPromotionPlans","MOFOKOM","4.1");
...
ACIPResourceAdaptorUsageParameters usage = (ACIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("GetPromotionPlans", this);
        ...
        if (originOperatorID!=null) 
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("GetPromotionPlans", this);
