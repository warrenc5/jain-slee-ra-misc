        ...
        **/
        @Generated(value={})
        public class DeleteSubscriberImpl implements DeleteSubscriber,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("acip.DeleteSubscriber","MOFOKOM","4.1");
...
ACIPResourceAdaptorUsageParameters usage = (ACIPResourceAdaptorUsageParameters)raUsageParameters; 
        ...
        if (originOperatorID==null) 
            Util.mandatoryMissing("originOperatorID","5.9.1");
        deleteReasonCode = decoder.decodeInteger("deleteReasonCode") ;
            }
        ...
        buffy.append(":");
         ...
         if(deleteReasonCode!=null){
         buffy.append("deleteReasonCode=");
         buffy.append(deleteReasonCode.toString());
         buffy.append(", ");
         }
        ...
        **/
          private java.lang.Integer deleteReasonCode;
          @Override
