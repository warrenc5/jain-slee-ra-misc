        ...
        **/
        @Generated(value={})
        public class UpdateTemporaryBlockedImpl implements UpdateTemporaryBlocked,Codeable{
              static EventTypeID eventTypeID = new EventTypeID("acip.UpdateTemporaryBlocked","MOFOKOM","4.1");
...
ACIPResourceAdaptorUsageParameters usage = (ACIPResourceAdaptorUsageParameters)raUsageParameters; 
            ...
            public void encode(Encoder encoder) {
              encoder.start("UpdateTemporaryBlocked", this);
        ...
        if (temporaryBlockedFlag==null) 
            Util.mandatoryMissing("temporaryBlockedFlag","5.3.1");
        else
            ...
            public void decode(Decoder decoder) throws InstantiationException, IllegalAccessException{
              decoder.start("UpdateTemporaryBlocked", this);
