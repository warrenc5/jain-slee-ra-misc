...
*
        ...
        **/
        @Generated(value={})
        public class UssdEndImpl  extends UssdCommandImpl implements UssdEnd{
            public UssdEndImpl(byte[] data){
              super(data);
              super.setCommandID(UssdEnd.intValue());
              fromByteArray(data);
            }
            public final static EventTypeID EVENT_TYPE_ID = new EventTypeID("UssdEnd", "MOFOKOM", "1.1");
            public UssdEndImpl(){
              super.setCommandID(UssdEnd.intValue());
            }
	      /**
