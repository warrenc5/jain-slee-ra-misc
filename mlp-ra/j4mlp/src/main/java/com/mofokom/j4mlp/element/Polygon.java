...
public class Polygon implements Serializable, Cloneable
{
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2013-03-27T04:24:15+11:00", comments = "JAXB RI vhudson-jaxb-ri-2.1-792")
    protected List<LinearRing> innerBoundaryIs;
    @XmlAttribute
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2013-03-27T04:24:15+11:00", comments = "JAXB RI vhudson-jaxb-ri-2.1-792")
    public void setOuterBoundaryIs(LinearRing value) {
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2013-03-27T04:24:15+11:00", comments = "JAXB RI vhudson-jaxb-ri-2.1-792")
    public List<LinearRing> getInnerBoundaryIs() {
        if (innerBoundaryIs == null) {
            innerBoundaryIs = new ArrayList<LinearRing>();
        }
    ...
    public String toString() {
        ...
        buffy.append("outerBoundaryIs=");
        if (outerBoundaryIs == null) {
            buffy.append("<null>");
        } else {
            buffy.append(outerBoundaryIs.toString());
        }
        buffy.append(",");
        buffy.append("innerBoundaryIs=");
        if (innerBoundaryIs == null) {
            buffy.append("<null>");
        } else {
            buffy.append("[");
            for (Object e: innerBoundaryIs) {
