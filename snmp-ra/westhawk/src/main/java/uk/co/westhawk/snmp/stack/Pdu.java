 ...
 */
public abstract class Pdu extends Observable implements Serializable
{
    ...
    protected transient SnmpContextBasisFace context;
    ...
    private transient Transmitter trans = null;
    private int         retries;
...
protected boolean isExpectingResponse()
{
    ...
    public void setContext(SnmpContextBasisFace context) {
