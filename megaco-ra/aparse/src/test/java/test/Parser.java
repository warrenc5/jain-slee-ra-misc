...
public class Parser
{
  ...
  static public void main(String[] args)
  {
    ...
    if (ok)
    {
      ...
      arguments.setProperty("Rule", "transactionResponseAck");
         ...
         ParserException
  {
    ...
    Rule rule = null;
    if (rulename.equalsIgnoreCase("transactionResponseAck")) rule = Rule$transactionResponseAck.parse(context);
    else if (rulename.equalsIgnoreCase("transactionAck")) rule = Rule$transactionAck.parse(context);
    else if (rulename.equalsIgnoreCase("TransactionID")) rule = Rule$TransactionID.parse(context);
    else if (rulename.equalsIgnoreCase("UINT32")) rule = Rule$UINT32.parse(context);
    ...
    else if (rulename.equalsIgnoreCase("ResponseAckToken")) rule = Rule$ResponseAckToken.parse(context);
    else if (rulename.equalsIgnoreCase("LBRKT")) rule = Rule$LBRKT.parse(context);
    else if (rulename.equalsIgnoreCase("RBRKT")) rule = Rule$RBRKT.parse(context);
