...
public class DigitStringPosition implements Serializable {
	...
	/**
	 * Identifies THE DIGIT E. Its value shall be set to 14.
	 */
	public static final int DIGITE = 14;

	/**
	 * Identifies THE DIGIT F. Its value shall be set to 15.
	 */
	public static final int DIGITF = 15;
	 ...
	 */
	public static final int DIGIT_STAR = 26;

	/**
	 * Identifies THE DIGIT HASH. Its value shall be set to 15.
	 */
	public static final int DIGIT_HASH = 27;


	private final static int _LOW_MARK = 0;
	private final static int _HIGH_MARK = 28;
...
bob.append("DigitStringPosition:");

if (digits !=null && digits.length > 0) { bob.append("digits=["); 
 for(int i = 0 ; i < digits.length; i ++ )
bob.append(digits[i]).append(",");
bob.append("]");}
...
javax.megaco.message.descriptor.DigitStringPosition o = (javax.megaco.message.descriptor.DigitStringPosition)oo;
if((digits !=null && o.digits == null) ||(digits == null && o.digits != null) ) return false;
if (digits ==null && o.digits == null) return true; else if (digits.length != o.digits.length) return false;
if (digits.length == o.digits.length) for(int i = 0 ; i < digits.length; i ++ )
