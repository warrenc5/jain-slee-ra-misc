...
bob.append("sessionDescription=").append(sessionDescription).append(",");
if(sessionDescStr !=null)
bob.append("sessionDescStr=").append(sessionDescStr).append(",");
...
javax.megaco.message.descriptor.SDPInfo o = (javax.megaco.message.descriptor.SDPInfo)oo;
if((sessionDescription !=null && o.sessionDescription == null) ||(sessionDescription == null && o.sessionDescription != null) ) return false;
if(sessionDescription ==null && o.sessionDescription == null) return true ; else if(sessionDescription !=null && o.sessionDescription != null)
if (sessionDescription != null && o.sessionDescription !=null && !sessionDescription.equals(o.sessionDescription)) return false;
if((sessionDescStr !=null && o.sessionDescStr == null) ||(sessionDescStr == null && o.sessionDescStr != null) ) return false;
if(sessionDescStr ==null && o.sessionDescStr == null) return true ; else if(sessionDescStr !=null && o.sessionDescStr != null)
if (sessionDescStr != null && o.sessionDescStr !=null && !sessionDescStr.equals(o.sessionDescStr)) return false;
