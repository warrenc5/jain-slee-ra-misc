...
public class SrvChngRespDescriptor extends Descriptor implements Serializable {
	...
	public void setTimeValue(java.lang.String timeValue) throws IllegalArgumentException {
		...
		if (timeValue == null) {
			new IllegalArgumentException("TimeValue must not be null.");
		}
...
bob.append("SrvChngRespDescriptor:");
...
javax.megaco.message.descriptor.SrvChngRespDescriptor o = (javax.megaco.message.descriptor.SrvChngRespDescriptor)oo;
