...
public class CommandReq extends CommandEvent {
     ...
     * to MG. * @param source 
     * @param assocHandle - The association handle to uniquely identify
...
bob.append("CommandReq:");
bob.append(super.toString());

bob.append("isCommandOptional=").append(isCommandOptional).append(",");
bob.append("isReqWithWildcardResp=").append(isReqWithWildcardResp).append(",");
bob.append("cmdRequestIdentifier=").append(cmdRequestIdentifier).append(",");
...
javax.megaco.message.CommandReq o = (javax.megaco.message.CommandReq)oo;
if (!super.equals(o)) return false;
if (isCommandOptional != o.isCommandOptional) return false;
if (isReqWithWildcardResp != o.isReqWithWildcardResp) return false;
if (cmdRequestIdentifier != o.cmdRequestIdentifier) return false;
