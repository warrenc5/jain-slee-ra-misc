...
public class CommandResp extends CommandEvent {
	...
	public int getCommandIdentifier() {
		return CommandType.M_COMMAND_RESP;
	}
...
bob.append("CommandResp:");
bob.append(super.toString());

bob.append("cmdRespIdentifier=").append(cmdRespIdentifier).append(",");
bob.append("isLastCommandResp=").append(isLastCommandResp).append(",");
...
javax.megaco.message.CommandResp o = (javax.megaco.message.CommandResp)oo;
if (!super.equals(o)) return false;
if (cmdRespIdentifier != o.cmdRespIdentifier) return false;
if (isLastCommandResp != o.isLastCommandResp) return false;
