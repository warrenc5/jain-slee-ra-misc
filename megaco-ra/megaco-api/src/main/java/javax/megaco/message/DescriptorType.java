...
bob.append("DescriptorType:");

bob.append("descriptor=").append(descriptor).append(",");
...
javax.megaco.message.DescriptorType o = (javax.megaco.message.DescriptorType)oo;
if (descriptor != o.descriptor) return false;
