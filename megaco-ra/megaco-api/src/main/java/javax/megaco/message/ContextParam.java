...
public class ContextParam implements Serializable {
     ...
     * @throws javax.megaco.ParameterNotSetException : This exception is raised
     * if the priority is not set and the get method is invoked.
     */
     ...
     *
     * @param isEMPresent - The boolean value to indicate if the emergency is
     * present as a part of the context level parameters.
     */
     ...
     *
     * @param priority priority - Integer value of the priority that shall be
     * set. The only valid values specified by the protocol for this parameters
     * is between 0 to 15.
     * @throws IllegalArgumentException : The valid values of priority ranges
     * between 0 to 15. If any value other than this is set then the exception
     * is raised.
     */
     ...
     *
     * @param topologyDescriptor The vector of reference to the object
     * identifier of type topology descriptor information
...
bob.append("ContextParam:");

bob.append("isEMPresent=").append(isEMPresent).append(",");
if (topologyDescriptors !=null && topologyDescriptors.length > 0) { bob.append("topologyDescriptors=["); 
 for(int i = 0 ; i < topologyDescriptors.length; i ++ )
if(topologyDescriptors[i] !=null)
bob.append(topologyDescriptors[i]).append(",");
bob.append("]");}
bob.append("isPriorityPresent=").append(isPriorityPresent).append(",");
bob.append("priority=").append(priority).append(",");
...
javax.megaco.message.ContextParam o = (javax.megaco.message.ContextParam)oo;
if (isEMPresent != o.isEMPresent) return false;
if((topologyDescriptors !=null && o.topologyDescriptors == null) ||(topologyDescriptors == null && o.topologyDescriptors != null) ) return false;
if(topologyDescriptors ==null && o.topologyDescriptors == null) return true ; else if(topologyDescriptors !=null && o.topologyDescriptors != null)
{
if (topologyDescriptors ==null && o.topologyDescriptors == null) return true; else if (topologyDescriptors.length != o.topologyDescriptors.length) return false;
if (topologyDescriptors.length == o.topologyDescriptors.length) for(int i = 0 ; i < topologyDescriptors.length; i ++ )
{
if((topologyDescriptors[i] !=null && o.topologyDescriptors[i] == null) ||(topologyDescriptors[i] == null && o.topologyDescriptors[i] != null) ) return false;
if(topologyDescriptors[i] !=null && o.topologyDescriptors[i] != null)
if (!topologyDescriptors[i].equals(o.topologyDescriptors[i])) return false;
}
}
if (isPriorityPresent != o.isPriorityPresent) return false;
