...
bob.append("SrvChngDescriptor:");
bob.append(super.toString());

if(srvChngMethod !=null)
bob.append("srvChngMethod=").append(srvChngMethod).append(",");
if(svcChngMethodExtension !=null)
bob.append("svcChngMethodExtension=").append(svcChngMethodExtension).append(",");
if(srvChngReason !=null)
bob.append("srvChngReason=").append(srvChngReason).append(",");
if(srvChngDelay !=null)
bob.append("srvChngDelay=").append(srvChngDelay).append(",");
...
if(dateValue !=null)
bob.append("dateValue=").append(dateValue).append(",");
if(timeValue !=null)
bob.append("timeValue=").append(timeValue).append(",");
if(parameterExtension !=null)
bob.append("parameterExtension=").append(parameterExtension).append(",");
...
javax.megaco.message.descriptor.SrvChngDescriptor o = (javax.megaco.message.descriptor.SrvChngDescriptor)oo;
...
if((svcChngMethodExtension !=null && o.svcChngMethodExtension == null) ||(svcChngMethodExtension == null && o.svcChngMethodExtension != null) ) return false;
if(svcChngMethodExtension ==null && o.svcChngMethodExtension == null) return true ; else if(svcChngMethodExtension !=null && o.svcChngMethodExtension != null)
if (svcChngMethodExtension != null && o.svcChngMethodExtension !=null && !svcChngMethodExtension.equals(o.svcChngMethodExtension)) return false;
if((srvChngReason !=null && o.srvChngReason == null) ||(srvChngReason == null && o.srvChngReason != null) ) return false;
if(srvChngReason ==null && o.srvChngReason == null) return true ; else if(srvChngReason !=null && o.srvChngReason != null)
if (srvChngReason != null && o.srvChngReason !=null && !srvChngReason.equals(o.srvChngReason)) return false;
if((srvChngDelay !=null && o.srvChngDelay == null) ||(srvChngDelay == null && o.srvChngDelay != null) ) return false;
if(srvChngDelay ==null && o.srvChngDelay == null) return true ; else if(srvChngDelay !=null && o.srvChngDelay != null)
if (srvChngDelay != null && o.srvChngDelay !=null && !srvChngDelay.equals(o.srvChngDelay)) return false;
...
if((dateValue !=null && o.dateValue == null) ||(dateValue == null && o.dateValue != null) ) return false;
if(dateValue ==null && o.dateValue == null) return true ; else if(dateValue !=null && o.dateValue != null)
if (dateValue != null && o.dateValue !=null && !dateValue.equals(o.dateValue)) return false;
if((timeValue !=null && o.timeValue == null) ||(timeValue == null && o.timeValue != null) ) return false;
if(timeValue ==null && o.timeValue == null) return true ; else if(timeValue !=null && o.timeValue != null)
if (timeValue != null && o.timeValue !=null && !timeValue.equals(o.timeValue)) return false;
if((parameterExtension !=null && o.parameterExtension == null) ||(parameterExtension == null && o.parameterExtension != null) ) return false;
if(parameterExtension ==null && o.parameterExtension == null) return true ; else if(parameterExtension !=null && o.parameterExtension != null)
if (parameterExtension != null && o.parameterExtension !=null && !parameterExtension.equals(o.parameterExtension)) return false;
