...
bob.append("SignalNotifyReason:");

bob.append("notifyReason=").append(notifyReason).append(",");
...
javax.megaco.message.descriptor.SignalNotifyReason o = (javax.megaco.message.descriptor.SignalNotifyReason)oo;
if (notifyReason != o.notifyReason) return false;
