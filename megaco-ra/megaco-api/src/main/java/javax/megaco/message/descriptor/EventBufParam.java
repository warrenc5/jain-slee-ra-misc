...
public class EventBufParam implements Serializable {
     ...
     *
     * @param eventItem
     * @throws IllegalArgumentException - Thrown if an invalid eventItem object
     * reference is set.
     */
     ...
     *
     * @param eventItemStr
     * @throws IllegalArgumentException - Thrown if an invalid eventItemStr
     ...
     * reference for megaco package event and which in turn has the reference
     * for the parameter info. If the parameter has not been set, then this
     ...
     * holds information about package name, item name and the parameters in the
     * string format. If the parameter has not been set, then this method shall
     * return NULL.
     */
     ...
     * This shall be returned only if the streamId is present in the event
     * parameter of the event buffer descriptor.
     * @throws javax.megaco.ParameterNotSetException - Thrown if streamId has
     * not been set. Thus this method should be called only after verifying that
     * the streamId is set using isStreamIdPresen
     */
     ...
     *
     * @param streamId - The integer value of the stream id shall be set.
     * @throws IllegalArgumentException - Thrown if streamId is set with an
     * invalid value.
     */
...
bob.append("EventBufParam:");

if(eventItemStr !=null)
bob.append("eventItemStr=").append(eventItemStr).append(",");
if(eventItem !=null)
...
javax.megaco.message.descriptor.EventBufParam o = (javax.megaco.message.descriptor.EventBufParam)oo;
if((eventItemStr !=null && o.eventItemStr == null) ||(eventItemStr == null && o.eventItemStr != null) ) return false;
if(eventItemStr ==null && o.eventItemStr == null) return true ; else if(eventItemStr !=null && o.eventItemStr != null)
if (eventItemStr != null && o.eventItemStr !=null && !eventItemStr.equals(o.eventItemStr)) return false;
