...
bob.append("EventBufferCtrl:");

bob.append("eventBufferCtrl=").append(eventBufferCtrl).append(",");
...
javax.megaco.message.descriptor.EventBufferCtrl o = (javax.megaco.message.descriptor.EventBufferCtrl)oo;
if (eventBufferCtrl != o.eventBufferCtrl) return false;
