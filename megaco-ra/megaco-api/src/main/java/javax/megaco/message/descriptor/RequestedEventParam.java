...
bob.append("RequestedEventParam:");

if(eventItem !=null)
bob.append("eventItem=").append(eventItem).append(",");
if(itemStr !=null)
bob.append("itemStr=").append(itemStr).append(",");
if(embedFirstEventParam !=null)
bob.append("embedFirstEventParam=").append(embedFirstEventParam).append(",");
if(eventParam !=null)
...
javax.megaco.message.descriptor.RequestedEventParam o = (javax.megaco.message.descriptor.RequestedEventParam)oo;
...
if((embedFirstEventParam !=null && o.embedFirstEventParam == null) ||(embedFirstEventParam == null && o.embedFirstEventParam != null) ) return false;
if(embedFirstEventParam ==null && o.embedFirstEventParam == null) return true ; else if(embedFirstEventParam !=null && o.embedFirstEventParam != null)
if (embedFirstEventParam != null && o.embedFirstEventParam !=null && !embedFirstEventParam.equals(o.embedFirstEventParam)) return false;
