...
bob.append("ExceptionInfoCode:");

bob.append("info_code=").append(info_code).append(",");
...
javax.megaco.ExceptionInfoCode o = (javax.megaco.ExceptionInfoCode)oo;
if (info_code != o.info_code) return false;
