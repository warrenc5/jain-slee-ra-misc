...
bob.append("PkgEventItem:");
bob.append(super.toString());

bob.append("eventId=").append(eventId).append(",");
if (paramInfo !=null && paramInfo.length > 0) { bob.append("paramInfo=["); 
 for(int i = 0 ; i < paramInfo.length; i ++ )
if(paramInfo[i] !=null)
bob.append(paramInfo[i]).append(",");
bob.append("]");}
...
javax.megaco.pkg.PkgEventItem o = (javax.megaco.pkg.PkgEventItem)oo;
if (!super.equals(o)) return false;
if (eventId != o.eventId) return false;
if((paramInfo !=null && o.paramInfo == null) ||(paramInfo == null && o.paramInfo != null) ) return false;
if(paramInfo ==null && o.paramInfo == null) return true ; else if(paramInfo !=null && o.paramInfo != null)
{
if (paramInfo ==null && o.paramInfo == null) return true; else if (paramInfo.length != o.paramInfo.length) return false;
if (paramInfo.length == o.paramInfo.length) for(int i = 0 ; i < paramInfo.length; i ++ )
{
if((paramInfo[i] !=null && o.paramInfo[i] == null) ||(paramInfo[i] == null && o.paramInfo[i] != null) ) return false;
if(paramInfo[i] !=null && o.paramInfo[i] != null)
if (!paramInfo[i].equals(o.paramInfo[i])) return false;
}
}
