...
bob.append("PkgSignalItem:");
bob.append(super.toString());

bob.append("signalId=").append(signalId).append(",");
if (pkgItemParam !=null && pkgItemParam.length > 0) { bob.append("pkgItemParam=["); 
 for(int i = 0 ; i < pkgItemParam.length; i ++ )
if(pkgItemParam[i] !=null)
bob.append(pkgItemParam[i]).append(",");
bob.append("]");}
...
javax.megaco.pkg.PkgSignalItem o = (javax.megaco.pkg.PkgSignalItem)oo;
if (!super.equals(o)) return false;
if (signalId != o.signalId) return false;
if((pkgItemParam !=null && o.pkgItemParam == null) ||(pkgItemParam == null && o.pkgItemParam != null) ) return false;
if(pkgItemParam ==null && o.pkgItemParam == null) return true ; else if(pkgItemParam !=null && o.pkgItemParam != null)
{
if (pkgItemParam ==null && o.pkgItemParam == null) return true; else if (pkgItemParam.length != o.pkgItemParam.length) return false;
if (pkgItemParam.length == o.pkgItemParam.length) for(int i = 0 ; i < pkgItemParam.length; i ++ )
{
if((pkgItemParam[i] !=null && o.pkgItemParam[i] == null) ||(pkgItemParam[i] == null && o.pkgItemParam[i] != null) ) return false;
if(pkgItemParam[i] !=null && o.pkgItemParam[i] != null)
if (!pkgItemParam[i].equals(o.pkgItemParam[i])) return false;
}
}
