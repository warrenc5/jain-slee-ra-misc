...
bob.append("itemId=").append(itemId).append(",");
bob.append("itemType=").append(itemType).append(",");
if(packageId !=null)
bob.append("packageId=").append(packageId).append(",");
if(associatedPkgId !=null)
bob.append("associatedPkgId=").append(associatedPkgId).append(",");
...
javax.megaco.pkg.PkgItem o = (javax.megaco.pkg.PkgItem)oo;
if (itemId != o.itemId) return false;
if (itemType != o.itemType) return false;
if((packageId !=null && o.packageId == null) ||(packageId == null && o.packageId != null) ) return false;
if(packageId ==null && o.packageId == null) return true ; else if(packageId !=null && o.packageId != null)
if (packageId != null && o.packageId !=null && !packageId.equals(o.packageId)) return false;
if((associatedPkgId !=null && o.associatedPkgId == null) ||(associatedPkgId == null && o.associatedPkgId != null) ) return false;
if(associatedPkgId ==null && o.associatedPkgId == null) return true ; else if(associatedPkgId !=null && o.associatedPkgId != null)
if (associatedPkgId != null && o.associatedPkgId !=null && !associatedPkgId.equals(o.associatedPkgId)) return false;
