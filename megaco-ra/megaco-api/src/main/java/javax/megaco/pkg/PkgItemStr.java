...
bob.append("PkgItemStr:");

if(pkgName !=null)
bob.append("pkgName=").append(pkgName).append(",");
if(itemName !=null)
bob.append("itemName=").append(itemName).append(",");
if(parameter !=null)
bob.append("parameter=").append(parameter).append(",");
if(itemType !=null)
bob.append("itemType=").append(itemType).append(",");
...
javax.megaco.pkg.PkgItemStr o = (javax.megaco.pkg.PkgItemStr)oo;
if((pkgName !=null && o.pkgName == null) ||(pkgName == null && o.pkgName != null) ) return false;
if(pkgName ==null && o.pkgName == null) return true ; else if(pkgName !=null && o.pkgName != null)
if (pkgName != null && o.pkgName !=null && !pkgName.equals(o.pkgName)) return false;
if((itemName !=null && o.itemName == null) ||(itemName == null && o.itemName != null) ) return false;
if(itemName ==null && o.itemName == null) return true ; else if(itemName !=null && o.itemName != null)
if (itemName != null && o.itemName !=null && !itemName.equals(o.itemName)) return false;
if((parameter !=null && o.parameter == null) ||(parameter == null && o.parameter != null) ) return false;
if(parameter ==null && o.parameter == null) return true ; else if(parameter !=null && o.parameter != null)
if (parameter != null && o.parameter !=null && !parameter.equals(o.parameter)) return false;
if((itemType !=null && o.itemType == null) ||(itemType == null && o.itemType != null) ) return false;
if(itemType ==null && o.itemType == null) return true ; else if(itemType !=null && o.itemType != null)
if (itemType != null && o.itemType !=null && !itemType.equals(o.itemType)) return false;
