...
public final class NetworkJitPrpt extends PkgPrptyItem {
	...
	protected int[] itemsDescriptorIds = new int[]{};
...
javax.megaco.pkg.NetworkPkg.NetworkJitPrpt o = (javax.megaco.pkg.NetworkPkg.NetworkJitPrpt)oo;
