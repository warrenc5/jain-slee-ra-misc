...
bob.append("AssocIndReason:");

bob.append("nwLinkupInd=").append(nwLinkupInd).append(",");
...
javax.megaco.association.AssocIndReason o = (javax.megaco.association.AssocIndReason)oo;
if (nwLinkupInd != o.nwLinkupInd) return false;
