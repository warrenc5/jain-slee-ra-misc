...
public class SrvChngReason implements Serializable {
	...
	/**
	 * Identifies the service change reason towards the peer shall be 916 -
	 * Packages Change
	 */
	public final static int M_R916 = 916;


	/**
	 * Identifies the service change reason towards the peer shall be 917 -
	 * Capabilities Change.
	 */
	public final static int M_R917 = 917;


	/**
	 * Identifies the service change reason towards the peer shall be 918 -
	 * Cancel Graceful.
	 */
	public final static int M_R918 = 918;


	/**
	 * Identifies the service change reason towards the peer shall be 919 -
	 * Warm Failover.
	 */
	public final static int M_R919 = 919;

	/**
	 * Identifies the service change reason towards the peer shall be 920 -
	 * Cold Failover.
	 */
	public final static int M_R920 = 920;
	 ...
	 * constant M_R916.
	 */
	public static final SrvChngReason R916 = new SrvChngReason(M_R916);

	/**
	 * Identifies a SrvChngReason object that constructs the class with the
	 * constant M_R917.
	 */
	public static final SrvChngReason R917 = new SrvChngReason(M_R917);

	/**
	 * Identifies a SrvChngReason object that constructs the class with the
	 * constant M_R918.
	 */
	public static final SrvChngReason R918 = new SrvChngReason(M_R918);

	/**
	 * Identifies a SrvChngReason object that constructs the class with the
	 * constant M_R919.
	 */
	public static final SrvChngReason R919 = new SrvChngReason(M_R919);

	/**
	 * Identifies a SrvChngReason object that constructs the class with the
	 * constant M_R920.
	 */
	public static final SrvChngReason R920 = new SrvChngReason(M_R920);
...
bob.append("SrvChngReason:");

bob.append("srvChngReasonId=").append(srvChngReasonId).append(",");
...
javax.megaco.association.SrvChngReason o = (javax.megaco.association.SrvChngReason)oo;
if (srvChngReasonId != o.srvChngReasonId) return false;
