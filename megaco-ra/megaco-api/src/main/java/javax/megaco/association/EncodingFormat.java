...
bob.append("EncodingFormat:");

bob.append("encodingFormat=").append(encodingFormat).append(",");
...
javax.megaco.association.EncodingFormat o = (javax.megaco.association.EncodingFormat)oo;
if (encodingFormat != o.encodingFormat) return false;
