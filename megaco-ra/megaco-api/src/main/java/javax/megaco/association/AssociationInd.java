...
public class AssociationInd extends AssociationEvent {
	...
	public int getSrvChngMethod() {
		return srvChngMethod == null ? 0 : srvChngMethod.getSrvChngMethodId();
	}
...
bob.append("AssociationInd:");
bob.append(super.toString());

if(assocIndReason !=null)
bob.append("assocIndReason=").append(assocIndReason).append(",");
if(localAddr !=null)
...
if(assocState !=null)
bob.append("assocState=").append(assocState).append(",");
...
if(remoteAddr !=null)
bob.append("remoteAddr=").append(remoteAddr).append(",");
...
javax.megaco.association.AssociationInd o = (javax.megaco.association.AssociationInd)oo;
if (!super.equals(o)) return false;
if((assocIndReason !=null && o.assocIndReason == null) ||(assocIndReason == null && o.assocIndReason != null) ) return false;
if(assocIndReason ==null && o.assocIndReason == null) return true ; else if(assocIndReason !=null && o.assocIndReason != null)
if (assocIndReason != null && o.assocIndReason !=null && !assocIndReason.equals(o.assocIndReason)) return false;
...
if((assocState !=null && o.assocState == null) ||(assocState == null && o.assocState != null) ) return false;
if(assocState ==null && o.assocState == null) return true ; else if(assocState !=null && o.assocState != null)
if (assocState != null && o.assocState !=null && !assocState.equals(o.assocState)) return false;
...
if (remoteAddr != null && o.remoteAddr !=null && !remoteAddr.equals(o.remoteAddr)) return false;
