...
bob.append("SrvChngMethod:");

bob.append("srvChngMethodId=").append(srvChngMethodId).append(",");
...
javax.megaco.association.SrvChngMethod o = (javax.megaco.association.SrvChngMethod)oo;
if (srvChngMethodId != o.srvChngMethodId) return false;
