...
bob.append("CommandEvent:");
bob.append(super.toString());

if (descriptorInfo !=null && descriptorInfo.length > 0) { bob.append("descriptorInfo=["); 
 for(int i = 0 ; i < descriptorInfo.length; i ++ )
if(descriptorInfo[i] !=null)
bob.append(descriptorInfo[i]).append(",");
bob.append("]");}
if(termination !=null)
bob.append("termination=").append(termination).append(",");
bob.append("assocHandle=").append(assocHandle).append(",");
bob.append("txnHandle=").append(txnHandle).append(",");
bob.append("actionHandle=").append(actionHandle).append(",");
bob.append("isFirstCommandInAction=").append(isFirstCommandInAction).append(",");
bob.append("txn_or_cmd_status=").append(txn_or_cmd_status).append(",");
if(contextInfo !=null)
bob.append("contextInfo=").append(contextInfo).append(",");
...
javax.megaco.CommandEvent o = (javax.megaco.CommandEvent)oo;
if (!super.equals(o)) return false;
if((descriptorInfo !=null && o.descriptorInfo == null) ||(descriptorInfo == null && o.descriptorInfo != null) ) return false;
if(descriptorInfo ==null && o.descriptorInfo == null) return true ; else if(descriptorInfo !=null && o.descriptorInfo != null)
{
if (descriptorInfo ==null && o.descriptorInfo == null) return true; else if (descriptorInfo.length != o.descriptorInfo.length) return false;
if (descriptorInfo.length == o.descriptorInfo.length) for(int i = 0 ; i < descriptorInfo.length; i ++ )
{
if((descriptorInfo[i] !=null && o.descriptorInfo[i] == null) ||(descriptorInfo[i] == null && o.descriptorInfo[i] != null) ) return false;
if(descriptorInfo[i] !=null && o.descriptorInfo[i] != null)
if (!descriptorInfo[i].equals(o.descriptorInfo[i])) return false;
}
}
if((termination !=null && o.termination == null) ||(termination == null && o.termination != null) ) return false;
if(termination ==null && o.termination == null) return true ; else if(termination !=null && o.termination != null)
if (termination != null && o.termination !=null && !termination.equals(o.termination)) return false;
if (assocHandle != o.assocHandle) return false;
if (txnHandle != o.txnHandle) return false;
if (actionHandle != o.actionHandle) return false;
if (isFirstCommandInAction != o.isFirstCommandInAction) return false;
if (txn_or_cmd_status != o.txn_or_cmd_status) return false;
if((contextInfo !=null && o.contextInfo == null) ||(contextInfo == null && o.contextInfo != null) ) return false;
if(contextInfo ==null && o.contextInfo == null) return true ; else if(contextInfo !=null && o.contextInfo != null)
if (contextInfo != null && o.contextInfo !=null && !contextInfo.equals(o.contextInfo)) return false;
